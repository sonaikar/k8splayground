...
MASTERS = 3
WORKERS = 1
MASTER_IP_START = "192.168.56.110"
WORKER_IP_START = "192.168.56.120"
LB_IP = "192.168.56.100"

Vagrant.configure("2") do |config|
  # Use Fedora 43 from custom URL
  config.vm.box = "43-cloud-base"
  config.vm.box_url = "https://muug.ca/mirror/fedora/linux/releases/43/Cloud/x86_64/images/Fedora-Cloud-Base-Vagrant-VirtualBox-43-1.6.x86_64.vagrant.virtualbox.box"
